            ...
            foreach (DataRow dr in ds.Tables[0].Rows) //.Select("AppCategory='OMS'"))
            {
                switch (dr["AppCategory"].ToString())
                {
                    case "OMS":
                        ...
                        OMSitem.ImageUrl = "/Images/Icon/" + dr["AppIcon"].ToString(); //"https://cockpitdashboard.000webhostapp.com/Image1.png";
                    ...
                    case "QMS":
                        ...
                        QMSitem.ImageUrl = "/Images/Icon/" + dr["AppIcon"].ToString();
                        if (dr["AppClass"].ToString() == "WEB")
                    ...
                    case "MMS":
                        ...
                        MMSitem.ImageUrl = "/Images/Icon/" + dr["AppIcon"].ToString();
                        if (dr["AppClass"].ToString() == "WEB")
                    ...
                    case "SCMS":
                        ...
                        SCMSitem.ImageUrl = "/Images/Icon/" + dr["AppIcon"].ToString();
                        if (dr["AppClass"].ToString() == "WEB")
